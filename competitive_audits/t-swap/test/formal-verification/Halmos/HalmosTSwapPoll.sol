...
contract TSwapPoolFormalVerification is Test {
    ...
    function checkDeposit() public {
        ...
        assert(pool.balanceOf(liquidityProvider) == 100e18);
        assert(weth.balanceOf(liquidityProvider) == 100e18);
        assert(poolToken.balanceOf(liquidityProvider) == 100e18);
        assert(weth.balanceOf(address(pool)) == 100e18);
