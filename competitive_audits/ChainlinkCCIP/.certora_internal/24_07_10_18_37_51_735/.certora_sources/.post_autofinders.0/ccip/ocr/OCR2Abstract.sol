...
abstract contract OCR2Abstract is ITypeAndVersion {
  ...
  function _configDigestFromConfigData(
    ...
    uint64 offchainConfigVersion,
    bytes memory offchainConfig
  ) internal pure returns (bytes32) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120000, 1037618708498) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120001, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120005, 19173961) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00126008, offchainConfig) }
    uint256 h = uint256(
      keccak256(
        abi.encode(
          chainId,
