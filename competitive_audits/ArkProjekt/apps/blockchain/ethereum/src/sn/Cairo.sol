...
//@audit has this been done. is this a secuirty risk?
...
library Cairo {
     ...
     *     @return The offset increment applied to deserialize and the deserialized value.
     */
    //@audit correct update for varible-?
    ...
    //@audit correct math? risk for loop?
