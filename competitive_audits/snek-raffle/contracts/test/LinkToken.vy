...
_ZERO_ADDRESS: constant(address) = 0x0000000000000000000000000000000000000000
...
def __init__(_name: String[32], _symbol: String[32], _decimals: uint8, _supply: uint256):
    ...
    log Transfer(_ZERO_ADDRESS, msg.sender, init_supply)
...
def mint(_to: address, _value: uint256):
    ...
    assert _to != _ZERO_ADDRESS
    self.totalSupply += _value
    self.balanceOf[_to] += _value
    log Transfer(_ZERO_ADDRESS, _to, _value)
...
def _burn(_to: address, _value: uint256):
    ...
    self.totalSupply -= _value
    self.balanceOf[_to] -= _value
    log Transfer(_to, _ZERO_ADDRESS, _value)
