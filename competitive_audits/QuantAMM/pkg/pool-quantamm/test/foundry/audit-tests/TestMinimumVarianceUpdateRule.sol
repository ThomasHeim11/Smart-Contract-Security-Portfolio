...
// contract ConcreteMinimumVarianceUpdateRule is MinimumVarianceUpdateRule {
...
//     function getIntermediateVariance(address _poolAddress) public view returns (int256[] memory) {
//         return intermediateVariance[_poolAddress];
//     }
// }

// contract TestMinimumVarianceUpdateRule is Test {
//     ConcreteMinimumVarianceUpdateRule updateRule;

//     function setUp() public {
//         updateRule = new ConcreteMinimumVarianceUpdateRule(address(this));
//     }
...
//         parameters[0][0] = 5 * 1e17; // 0.5 in SD59x18
...
//         // Verify the state
//         int256[] memory storedValues = updateRule.getIntermediateVariance(poolAddress);
...
//         for (uint256 i = 0; i < numberOfAssets; i++) {
//             parameters[0][i] = 5 * 1e17; // lambda short
//         }
