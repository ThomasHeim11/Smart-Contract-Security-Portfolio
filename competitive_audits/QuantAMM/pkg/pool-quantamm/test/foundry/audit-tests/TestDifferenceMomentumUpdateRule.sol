...
// import "../../../contracts/rules/DifferenceMomentumUpdateRule.sol";

// contract ConcreteDifferenceMomentumUpdateRule is DifferenceMomentumUpdateRule {
...
//     function unpackIntermediateValues(int256[] memory packedValues, uint256 numberOfAssets)
//         public
//         pure
//         returns (int256[] memory)
//     {
//         return _quantAMMUnpack128Array(packedValues, numberOfAssets);
//     }
// }

// contract TestDifferenceMomentumUpdateRule is Test {
//     ConcreteDifferenceMomentumUpdateRule updateRule;

//     function setUp() public {
//         updateRule = new ConcreteDifferenceMomentumUpdateRule(address(this));
//     }
...
//         parameters[1][0] = 5 * 1e17; // lambda short
...
//         // Verify the state
//         int256[] storage storedValues = updateRule.shortMovingAverages(poolAddress);
//         int256[] memory unpackedValues = updateRule.unpackIntermediateValues(storedValues, numberOfAssets);

//         console.log("Unpacked Values length:", unpackedValues.length);
//         console.logInt(unpackedValues[0]);
//         console.logInt(unpackedValues[1]);

//         assertEq(unpackedValues.length, 2);
//         assertEq(unpackedValues[0], 1 * 1e18);
//         assertEq(unpackedValues[1], 2 * 1e18);
//     }
...
//         parameters[1] = new int256[](numberOfAssets);

//         for (uint256 i = 0; i < numberOfAssets; i++) {
//             parameters[0][i] = 1 * 1e18; // kappa
//             parameters[1][i] = 5 * 1e17; // lambda short
//         }
