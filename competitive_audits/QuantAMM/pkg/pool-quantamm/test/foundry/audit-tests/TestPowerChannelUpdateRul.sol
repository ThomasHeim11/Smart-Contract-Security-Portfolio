...
contract ConcretePowerChannelUpdateRule is PowerChannelUpdateRule {
...
contract TestPowerChannelUpdateRule is Test {
    ConcretePowerChannelUpdateRule updateRule;

    function setUp() public {
        updateRule = new ConcretePowerChannelUpdateRule(address(this));
    }
    ...
    function testGetWeights() public {
        ...
        parameters[1][0] = 2 * 1e18; // q
        parameters[2][0] = 0; // use moving average
