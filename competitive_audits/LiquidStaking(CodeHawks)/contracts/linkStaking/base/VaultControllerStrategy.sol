...
contract VaultDepositController is Strategy {
     ...
     */
    //@audit safeTransferFrom can be exploited???correct variubles???
        ...
        returns (uint256)
    {
        ...
        //@audit shadowing can be exploited?? what function???
...
abstract contract VaultControllerStrategy is Strategy {
     ...
     */
    function getDepositChange() public view virtual returns (int256) {
    ...
    function getMinDeposits() public view virtual override returns (uint256) {
        return fundFlowController.claimPeriodActive() ? totalDeposits - totalUnbonded : totalDeposits;
    }
