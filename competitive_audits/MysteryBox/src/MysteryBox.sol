...
contract MysteryBox {
    ...
    //@audit should not onlyOwner form Zeppelin be used?
    ...
    //@audit can the payable function be explited?
    ...
    function openBox() public {
        ...
        //@audit weak randomnes. use chanlink vrf!!!!
