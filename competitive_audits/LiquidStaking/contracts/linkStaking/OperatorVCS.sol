...
contract OperatorVCS is VaultControllerStrategy {
     ...
     * @return total fees
     */
    //@audit varible updated correctly???
        ...
        return totalDeposits
            + (
                stakeController.isActive()
                    ? MathUpgradeable.min(
                        vaults.length * maxDeposits - totalPrincipalDeposits - totalRemovedDepositRoom,
    ...
    // @audit can a vault be deleted to breack protovol???
    /**
